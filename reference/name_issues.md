...
- ...:
  ...
  Named parameters to only get back (e.g. bbmn), or to remove (e.g.
  -bbmn).
...
**This function is deprecated.** It depends on
[`name_usage()`](https://docs.ropensci.org/rgbif/reference/name_usage.md)
which only works with the GBIF Backbone Taxonomy. Use
`rcol::col_usage()` from the rcol package to parse and examine name
issues with COL XR support.
